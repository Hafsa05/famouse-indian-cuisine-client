		...
		<div>
			<Container >
				...
				<p className='fs-4 fw-semibold'>
					1. Que: Tell us the differences between uncontrolled and controlled components. <br /></p>
				<p className='fs-5'>
					<span className='text-success'>Ans:</span> A controlled component in React is one that is controlled by React state, whereas an uncontrolled component keeps its own internal state. The parent component handles the state of the controlled component, which gets its current value and an update callback through props. When the user interacts with the component, the parent component changes the state, which changes the value of the component. An uncontrolled component keeps its own internal state, and when the user interacts with it, it changes its own state, which modifies the component's value. <br />
				...
				<p className='fs-4 fw-semibold'>
					2. Que: How to validate React props using PropTypes. </p>
				<p className='fs-5'>
